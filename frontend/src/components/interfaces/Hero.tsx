                ...
                <div className="flex flex-col items-center gap-20 lg:flex-row lg:items-start">
                    <div className="max-w-[38.125rem]">
                        ...
                        <p className="mt-6 text-lg font-bold text-zinc-950">
                            ...
                            , sin quimicos ni ultraprocesados, para mejorar la
                            calidad de vida de tus compañeros peludos. Cada
                            producto esta hecho con el mismo amor y cuidado que
                        ...
                        <div className="border-muted2 mt-12 flex gap-14 border-t">
                            ...
                            <div className="border-muted2 mt-8 border-l pl-12">
                                ...
                                >
                                    <Play className="m-auto size-3.5 fill-primary transition" />
                                </button>
                    ...
                    <div className="mx-auto">
                        <div className="grid grid-cols-[4.8rem_5.625rem_10.75rem] grid-rows-[9.3rem_8.68rem_1.125rem_3.875rem] gap-[0.625rem] sm:grid-cols-[5.3rem_6.25rem_12rem] sm:grid-rows-[10.3rem_9.625rem_1.25rem_4.3rem] sm:gap-[0.8rem] xl:grid-cols-[_8.5rem_10rem_19.3rem] xl:grid-rows-[16.625rem_15.5rem_1.375rem_6.9rem] xl:gap-[1.25rem]">
                            ...
                            <div className="col-[1_/_2] row-[1_/_2] self-end">
                                <svg
                                    className="w-[4.375rem] fill-primary xl:w-[8rem]"
                                    viewBox="0 0 131 174"
                                    fill="none"
                            ...
                            <div className="col-[1_/_3] overflow-hidden rounded-3xl bg-muted">
                                <div className="p-5 xl:p-7">
                                    ...
                                    <p className="mt-3 text-xs font-bold text-foreground md:text-sm xl:mt-5 xl:text-2xl">
                                        Sin químicos
                                    </p>
                                    <p className="text-xs font-bold text-foreground md:text-sm xl:text-2xl">
                                        Sin aditivos
                                    </p>
                                    <p className="text-xs font-bold text-primary md:text-sm xl:text-2xl">
                                        Solo amor en cada porción
                                    </p>
                                </div>
                            </div>
