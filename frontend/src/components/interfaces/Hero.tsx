            ...
            <div className="container mx-auto px-2">
                <div className="flex flex-col items-center gap-20 lg:flex-row lg:items-start">
                    <div className="max-w-[38.125rem]">
                        ...
                        <h1 className="text-3xl pb-12 font-sans font-medium text-primary lg:text-5xl">
                            Barker Shop
                        </h1>
                        <p className="mt-6 text-lg text-muted-foreground">
                            En Barker, nos dedicamos a alimentoss para perros y
                            gatos, ofreciendo una amplia gama de productos de
                            alta calidad para el cuidado y bienestar de tus
                            mascotas. Nos enfocamos en brindar alimentos
                            nutritivos y deliciosos, elaborados con ingredientes
                            seleccionados cuidadosamente para garantizar la
                            salud y felicidad de tus compañeros peludos.
                        </p>
                        ...
                        <div className="border-muted2 mt-12 flex gap-14 border-t">
                            <div className="mt-8">
                                <div className="relative flex -space-x-5">
                                    <span
                                        data-slot="avatar"
                                        className="flex size-8 shrink-0 overflow-hidden border-muted2 relative h-14 w-14 rounded-full border-2"
                                    >
                                        <img
                                    ...
                                    <div className="border-muted2 relative flex h-14 w-14 flex-shrink-0 rounded-full border-2 bg-white">
                                        <PlusIcon className="m-auto size-4 fill-slate-900" />
                                    </div>
                                </div>
                            ...
                            <div className="border-muted2 mt-8 border-l pl-12">
                                <button
                                    data-slot="button"
                                    className="items-center justify-center gap-2 whitespace-nowrap text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([className*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 size-9 group flex h-14 w-14 rounded-full border border-primary transition hover:scale-110"
                                >
                                    <svg
                                ...
                                <p className="mt-4 max-w-64 text-base leading-tight font-light text-muted-2-foreground">
                                    Mira el video para conocer más sobre
                                    nosotros y nuestros productos
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-[4.8rem_5.625rem_10.75rem] grid-rows-[9.3rem_8.68rem_1.125rem_3.875rem] gap-[0.625rem] sm:grid-cols-[5.3rem_6.25rem_12rem] sm:grid-rows-[10.3rem_9.625rem_1.25rem_4.3rem] sm:gap-[0.8rem] xl:grid-cols-[_8.5rem_10rem_19.3rem] xl:grid-rows-[16.625rem_15.5rem_1.375rem_6.9rem] xl:gap-[1.25rem]">
                            ...
                            <div className="col-[1_/_3] overflow-hidden rounded-3xl bg-muted">
                                <div className="p-5 xl:p-7">
                                    <div className="flex gap-7">
                                        ...
                                        <Rocket className="size-9 stroke-primary mt-3.5 xl:size-14 " />
                                    </div>
                            ...
                            <div className="col-[-2_/_-1] row-[-1_/_-2]">
                                <div className="flex w-full items-center gap-3">
                                    <div className="h-12 w-12 flex-shrink-0 rounded-full bg-muted"></div>
